...
import { newuserService,  alertService } from '@/_services';
...
function AddEdit({ history, match }) {
    ...
    function createUser(data) {
        return newuserService.create(data)
            .then(() => {
    ...
    function updateUser(id, data) {
        return newuserService.update(id, data)
            .then(() => {
    ...
    useEffect(() => {
        if (!isAddMode) {
            ...
            newuserService.getById(id).then(user => {
